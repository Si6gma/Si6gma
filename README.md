...
struct Engineer {
    char* name = "Si6gma";
    char* role = "Embedded Systems Engineer in Training";
    char* focus[] = {"Microcontrollers", "Real-time Systems", "Telemetry"};
    char* languages[] = {"C", "C++", "Python", "JavaScript"};
    bool caffeinePowered = true;
};
```
  ...
  <tr>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><em>Face-tracking laser pointer using OpenCV and Arduino-controlled servos. Because why not?</em></p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">
        <a href="https://github.com/Si6gma/rallyTelemetry">
          ...
          <img src="https://img.shields.io/badge/Embedded-FF6B6B?style=flat" />
          <img src="https://img.shields.io/badge/Real--Time-4ECDC4?style=flat" />
        </a>
        <p><em>Real-time data acquisition system for rally cars. Captures and logs high-speed sensor data.</em></p>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <div align="center">
        <a href="https://github.com/Si6gma/PianoSoundBoard">
          <img src="https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white" />
          <img src="https://img.shields.io/badge/Audio-FF9500?style=flat" />
        </a>
        <p><em>Digital audio processing project for piano sound synthesis and manipulation.</em></p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><em>Embedded systems laboratory for experimenting with sensors, actuators, and control algorithms.</em></p>
      </div>
    </td>
  </tr>
</table>
